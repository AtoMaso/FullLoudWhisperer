...
var AddAuthorComponent = (function () {
    //*****************************************************
    // CONSTRUCTOR IMPLEMENTAION
    //*****************************************************
    function AddAuthorComponent(_routeParams, _router, _memberService, _authorService, _teamService, _locationService, _levelService, _positionService, _pmService, _pageTitleService, _loggerService, _formBuilder) {
    ...
    // GET DATA
    //****************************************************
    AddAuthorComponent.prototype.getMembers = function () {
        var _this = this;
    ...
    AddAuthorComponent.prototype.getAuthors = function () {
        var _this = this;
    ...
    AddAuthorComponent.prototype.getLevels = function () {
        var _this = this;
    ...
    AddAuthorComponent.prototype.getPositions = function () {
        var _this = this;
    ...
    AddAuthorComponent.prototype.getTeams = function () {
        var _this = this;
    ...
    AddAuthorComponent.prototype.getLocations = function () {
        var _this = this;
    ...
    // SUBMIT REQUEST
    //****************************************************
    AddAuthorComponent.prototype.saveAuthor = function () {
    ...
    AddAuthorComponent.prototype.addAuthor = function (author) {
        var _this = this;
        if (!author) {
            return;
        }
    ...
    AddAuthorComponent.prototype.onSubmit = function () { this.isSubmitted = true; };
    //****************************************************
    // PRIVATE METHODS
    //****************************************************
    // success, the member has been added to the team
    AddAuthorComponent.prototype.onSuccessAddAuthor = function (passedAuthor) {
    ...
    AddAuthorComponent.prototype.doesAuthorExists = function () {
        var _this = this;
        var findauthor = null;
    ...
    AddAuthorComponent.prototype.onError = function (err, type) {
        var message = "";
        // stop the spinner
        this.isRequesting = false;
...
//# sourceMappingURL=add-author.component.js.map